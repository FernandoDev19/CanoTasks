...
export default function Input({
    ...
    return (
        <View
            className={`h-16 bg-white shadow-md rounded-lg px-4 flex-row items-center gap-4`}
        >
            {type === "search" && (
                <Ionicons name="search" size={20} color="#283044" />
            )}
            <TextInput
                className={`flex-1 text-xl font-bold focus-visible:outline-none text-text-base-${colorScheme}`}
